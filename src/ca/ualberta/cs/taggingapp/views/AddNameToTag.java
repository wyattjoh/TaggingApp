...
/**
 * @author Tagging Group Activity that controls the text input screen for adding
 *         names to new bounding boxes. After a bounding box is selected from
 *         the previous screen (AddTag), the user is brought to this screen to
 *         assign a new name and URL to the region.
 * 
 */
